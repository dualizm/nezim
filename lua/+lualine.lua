...
conditions = {buffer_not_empty = _1_, hide_in_width = _2_, check_git_workspace = _3_}
local config = {options = {component_separators = "", section_separators = "", theme = {normal = {c = {fg = colors.fg, bg = "002730"}}, inactive = {c = {fg = colors.fg, bg = "002730"}}}}, sections = {lualine_a = {}, lualine_b = {}, lualine_y = {}, lualine_z = {}, lualine_c = {}, lualine_x = {}}, inactive_sections = {lualine_a = {}, lualine_b = {}, lualine_y = {}, lualine_z = {}, lualine_c = {}, lualine_x = {}}}
...
ins_left({cond = conditions.buffer_not_empty, "filesize"})
...
ins_left({_6_})
ins_right({fmt = string.upper, cond = conditions.hide_in_width, color = {fg = colors.green, gui = "bold"}, "o:encoding"})
ins_right({fmt = string.upper, color = {fg = colors.green, gui = "bold"}, icons_enabled = false, "fileformat"})
ins_right({icon = "\239\145\191", color = {fg = colors.violet, gui = "bold"}, "branch"})
ins_right({symbols = {added = "\239\131\190 ", modified = "\239\167\137 ", removed = "\239\133\134 "}, diff_color = {added = {fg = colors.green}, modified = {fg = colors.orange}, removed = {fg = colors.red}}, cond = conditions.hide_in_width, "diff"})
local function _7_()
  return ("\226\150\138")()
end
